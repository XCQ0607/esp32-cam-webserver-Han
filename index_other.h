...
<html>
  <head>
    ...
    <title id="title">ESP32-CAM 简化视图</title>
  ...
  <body>
    <section class="main">
      <div id="logo">
        <label for="nav-toggle-cb" id="nav-toggle" style="float:left;" title="设置">&#9776;&nbsp;</label>
        <button id="swap-viewer" style="float:left;" title="切换到完整功能查看器">完整</button>
    ...
    const updateValue = (el, value, updateRemote) => {
      ...
      if (updateRemote && initialValue !== value) {
        ...
        if(el.id === "lamp"){
          ...
          console.log('名称设置为: ' + value);
        } else if(el.id === "code_ver"){
          console.log('固件版本: ' + value);
...
<html>
  ...
  <body style="text-align: center;">
    ...
    <div class="input-group" style="margin: auto; width: max-content;">
      ...
      <button>进阶浏览</button></a>
      <a href="<STREAMURL>view" title="Click here for the dedicated stream viewer" style="text-decoration: none;" target="_blank">
      <button>直接浏览</button></a>
    </div>
    <hr>
    <a href="<APPURL>dump" title="Information dump page" target="_blank">摄像机信息</a><br>
    <p style="margin-top: 10px; font-size: 0.8em;">Author - XCQ</p>
  </body>
</html>)=====";
...
<html>
  <head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width,initial-scale=1">
    <title id="title"><CAMNAME> - 错误</title>
    <link rel="icon" type="image/png" sizes="32x32" href="/favicon-32x32.png">
