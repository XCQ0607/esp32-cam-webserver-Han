...
The web UI has had changes to add the lamp control (only when enabled) and make the streamm window rotate and resize appropriately. I also made the '开始视频流' and 'Snapshot' controls more prominent, and added feedback of the camera name + firmware.
